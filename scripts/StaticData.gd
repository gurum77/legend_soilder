...
var stage_informations:Dictionary={
	...
	"세갈래길" : StageInformation.new("res://maps/BattleField_ThreeWays.tscn", Vector2(918, 449)),
	"끊어진다리" : StageInformation.new("res://maps/BattleField_BrokenBridge.tscn", Vector2(918, 449)),
	"각개전투" : StageInformation.new("res://maps/BattleField_IndividualBattles.tscn", Vector2(918, 449)),
